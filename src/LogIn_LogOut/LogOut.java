...
public class LogOut {
	...
	public void Logout() throws InterruptedException {
	    driver.get(baseUrl); // Điều hướng trình duyệt về trang chủ
		//Ấn vào đăng xuất người dùng
		driver.findElement(By.id("dropdown-user")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("/html/body/div[2]/nav/div/ul/li[2]/div/a[2]")).click();
       	String expectedUrl = "https://cntttest.vanlanguni.edu.vn:18081/Phancong02/Account/Login";
  		String actualUrl = driver.getCurrentUrl();
  		if(actualUrl.toString().equalsIgnoreCase(expectedUrl.toString())) {
  		System.out.println("Đăng xuất thành công tài khoản VLU - PASS");
  		}
    	else {
    		System.out.println("Có lỗi xảy ra - FAIL");
    	}
	}
   @AfterTest
