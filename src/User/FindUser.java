...
public class FindUser {
	...
	@Test(priority = 2)
	public void TimKiem_NguoiDung()throws InterruptedException {
		driver.findElement(By.xpath("//*[@id=\"tblUser_filter\"]/label/input")).sendKeys("hao.207ct47746@vanlanguni.vn");
		Thread.sleep(2000);
		
		WebElement Message = driver.findElement(By.xpath("//*[@id=\"tblUser\"]/tbody/tr/td[4]"));
        if (Message.isDisplayed() && Message.getText().equals("hao.207ct47746@vanlanguni.vn")) {
        	System.out.println("Thông báo: Tìm kiếm thành công người dùng - PASS");
        } else {
